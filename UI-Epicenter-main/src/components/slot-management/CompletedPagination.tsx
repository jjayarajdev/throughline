...
export default function CompletedPagination() {
  const [columns, setColumns] = useState<any[]>([
    { id: "hrqId", label: "HRQ ID", visible: true, sortable: false },
    {
      id: "candidateCode",
      label: "Candidate ID",
      visible: true,
    ...
    { id: "intakeStatusName", label: "Status", visible: true, sortable: false },
  ...
  const [sortConfig, setSortConfig] = useState<SortConfig>({
    ...
    const [statusId, setStatusId] = useState([15009]);
  ...
  return (
    <div className="p-2">
      <h1 className="text-xl font-semibold mb-6">Completed</h1>
